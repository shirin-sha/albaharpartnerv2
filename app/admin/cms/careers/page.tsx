...
type CareersSectionId = (typeof CAREERS_SECTIONS)[number]['id'];
...
export default function CareersManager() {
  ...
  const loadContent = async () => {
    ...
    try {
      ...
      const [ltrRes, rtlRes] = await Promise.all([
        fetch('/api/careers?language=ltr'),
        fetch('/api/careers?language=rtl'),
      ]);
  ...
  const getEmptyContent = (lang: 'ltr' | 'rtl'): CareersContent => ({
    language: lang,
    isActive: true,
    seo: {
      title: '',
              ...
              <div className="form-row-bilingual">
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setContentLtr({ ...(contentLtr as CareersContent), seo: { ...(contentLtr?.seo ?? { title: '', description: '', keywords: [] }), title: e.target.value } })
                    }
                  />
                </div>
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setContentRtl({ ...(contentRtl as CareersContent), seo: { ...(contentRtl?.seo ?? { title: '', description: '', keywords: [] }), title: e.target.value } })
                    }
                  />
                </div>
              </div>
              <div className="form-row-bilingual">
                <div className="form-group">
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setContentLtr({ ...(contentLtr as CareersContent), seo: { ...(contentLtr?.seo ?? { title: '', description: '', keywords: [] }), description: e.target.value } })
                    }
                  />
                </div>
                <div className="form-group">
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setContentRtl({ ...(contentRtl as CareersContent), seo: { ...(contentRtl?.seo ?? { title: '', description: '', keywords: [] }), description: e.target.value } })
                    }
                  />
                </div>
              </div>
      ...
      case 'careers':
        return (
          <div className="admin-cms-section-card" style={{ marginBottom: 24 }}>
            <div className="admin-cms-section-header" style={{ cursor: 'default' }}>
              <div>
                <h3 style={{ margin: 0 }}>Editing: Careers Section</h3>
            ...
            <div className="admin-cms-form">
              ...
              <div className="form-actions">
                <button
                  className="button button-primary"
                  onClick={() => handleSaveSection('careers')}
                  disabled={saving === 'careers'}
                >
                  {saving === 'careers' ? 'Saving...' : 'Save Careers Section'}
                </button>
              </div>
            </div>
          </div>
  ...
  return (
    <div className="admin-cms-container">
      ...
      <div className="admin-cms-section-card" style={{ marginBottom: 24 }}>
        <div className="admin-cms-section-header" style={{ cursor: 'default' }}>
          <div>
            <h3 style={{ margin: 0 }}>Jobs Management</h3>
            <div style={{ fontSize: 13, opacity: 0.8 }}>Jobs are managed separately.</div>
          </div>
          <Link href="/admin/managecareers" className="button button-primary">
